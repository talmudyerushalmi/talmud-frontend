...
const lines = [
  1, 2, 3, 4, 5, 6, 6, 7, 8, 8, 9, 23, 4, 234, 4, 234, 234, 324, 2344, 5, 6, 6, 7, 8, 8, 9, 23, 4, 234, 4, 234, 234,
  324, 2344, 5, 6, 6, 7, 8, 8, 9, 23, 4, 234, 4, 234, 234, 324, 234,
];
    ...
    <Layout>
      ...
      <Container>
        ...
        <Grid style={{ height: '100%' }} container>
          ...
          <Grid item sm={4}>
            <div style={{ top: '0', height: `98vh`, position: 'sticky', background: 'grey' }}>sticky</div>
          </Grid>
        </Grid>
      </Container>
    </Layout>
