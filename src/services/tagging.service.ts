...
export const TAGGING_CATEGORIES = [
  { id: 'role_1', label: 'משנה', color: '#e53935' },
  { id: 'role_2', label: 'היגד', color: '#8e24aa' },
  { id: 'role_3', label: 'ראיה', color: '#1e88e5' },
  { id: 'role_4', label: 'פירוש', color: '#43a047' },
  { id: 'role_5', label: 'סיוע', color: '#00897b' },
  { id: 'role_6', label: 'שאלה', color: '#fb8c00' },
  { id: 'role_7', label: 'תשובה', color: '#3949ab' },
  { id: 'role_8', label: 'קושיה', color: '#d81b60' },
  { id: 'role_9', label: 'תירוץ', color: '#039be5' },
  { id: 'role_10', label: 'פסיקה', color: '#7cb342' },
  { id: 'role_11', label: 'דחייה', color: '#c62828' },
  { id: 'role_12', label: 'הערה', color: '#6d4c41' },
  { id: 'role_13', label: 'הדגמה', color: '#00acc1' },
  { id: 'role_14', label: 'מעשה', color: '#f4511e' },
  { id: 'role_15', label: 'סיכום', color: '#546e7a' },
  { id: 'role_16', label: 'התאמה', color: '#ab47bc' },
  { id: 'role_17', label: 'הגהה', color: '#5c6bc0' },
  { id: 'role_18', label: 'המשך', color: '#26a69a' },
  { id: 'role_28', label: 'שונות', color: '#78909c' },
];
