    ...
    <>
      <Container style={{ textAlign: 'center' }}>
        ...
        <div dir="ltr">
          ...
          <p>DICTA Analytical tools for Hebrew texts (Prof. Moshe Koppel. Dr. Avi Shmidman)</p>
          <p>Yad Harav Herzog: Institute for the Complete Israeli Talmud</p>
        </div>

        <p>בשיתוף פעולה עם:</p>
        <p>הקתדרה לחקר התלמוד הירושלמי ע"ש מרן הרב הראשי אלוף הרב שלמה גורן זצ"ל, אוניברסיטת בר-אילן</p>
